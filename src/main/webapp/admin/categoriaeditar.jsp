...
<div class="container" style="margin-top: 100px">
	<div class="row">
		<div class="col-md-12">
			...
			<form:form method="POST" data-toggle="validator" id="form"  action="/botanica/admin/categorias"
				modelAttribute="categoria" role="form" cssClass="form-horizontal"
					...
					<div class="form-group ${status.error ? 'has-error' : '' }">
						...
						<div class="col-md-7">
							<textarea class="form-control" rows="5" class="form-control" name="descripcion"
								rows="22" id="descripcion" placeholder="Descripcion">${categoria.descripcion}</textarea>
							<c:if test="${status.error}">
								<span class="text-danger">${status.errorMessage}</span>
							</c:if>
						</div>
