...
<!-- Bootstrap core CSS -->
<link href="/botanica/vendor/bootstrap/css/bootstrap.css" rel="stylesheet">

<!-- Custom fonts for this template -->
<link href="/botanica/vendor/font-awesome/css/font-awesome.css" rel="stylesheet"
	type="text/css">
<link
...
<link href="/botanica/css/creative.css" rel="stylesheet">
...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="/botanica/default">Botanica</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<c:if test="${not empty session}">
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="/botanica/usuario">Datos de Usuario</a></li>
					</c:if>
