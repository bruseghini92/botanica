...
public class VentasController {
	...
	public ResponseEntity<Void> insert(String producto, String descripcion, Integer usuarioId, Boolean cerrado,
		...
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");// para transformar la hora de
																						// string a date
	 ...
	 * Integer id) { if(ventaServiceImpl.findById(id)==null) return new
	 * ResponseEntity<Void>(HttpStatus.BAD_REQUEST); else {
	 * ventaServiceImpl.remove(ventaServiceImpl.findById(id)); return new
